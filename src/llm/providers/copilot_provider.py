"""
Custom GitHub Copilot provider for Currency Assistant.
...
class CopilotProvider(BaseLLMProvider):
    def __init__(self, config: ProviderConfig):
        ...
        logger.debug(f"Initialized GitHub Copilot provider with model: {self.model}")
    ...
    async def health_check(self) -> bool:
        ...
        try:
            ...
            logger.warning(f"Copilot health check failed: {e}")
            return False
