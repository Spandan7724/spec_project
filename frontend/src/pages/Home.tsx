  ...
  const OverviewTab = (
    <div className="space-y-6 md:space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 md:gap-6">
        <Link
          to="/chat"
          className="group p-4 md:p-6 border rounded-lg transition-colors hover:bg-accent hover:border-accent/60 min-h-[120px] flex flex-col justify-center"
        >
          <h2 className="text-xl md:text-2xl font-semibold mb-2 transition-colors group-hover:text-accent-foreground">
            Chat Interface
          </h2>
          <p className="text-xs md:text-sm text-muted-foreground transition-colors group-hover:text-accent-foreground/90">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-4">
        <div className="p-4 md:p-5 border rounded-lg bg-card min-h-[100px]">
          <div className="flex items-center gap-3">
            <MessageSquare className="text-primary flex-shrink-0" size={20} />
            <div>
              <p className="text-xs md:text-sm text-muted-foreground">Active Sessions</p>
              <p className="text-xl md:text-2xl font-bold">{Object.keys(chatSessions).length}</p>
            </div>
          </div>
        </div>
        <div className="p-4 md:p-5 border rounded-lg bg-card min-h-[100px]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl font-bold">{analysisHistory.length}</p>
            </div>
          </div>
        </div>
        <div className="p-4 md:p-5 border rounded-lg bg-card min-h-[100px]">
    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
          <h2 className="text-xl md:text-2xl font-semibold">Recent Conversations</h2>
          <Link to="/chat" className="text-xs md:text-sm text-primary hover:underline w-fit">
            Start New Chat →
          </Link>
        </div>
        {recentSessions.length > 0 ? (
          ...
          <div className="p-6 md:p-8 border rounded-lg text-center text-muted-foreground">
            <MessageSquare size={48} className="mx-auto mb-3 opacity-50" />
            <p className="text-xs md:text-sm">No conversations yet. Start a chat to get personalized recommendations!</p>
          </div>
        )}
      </div>
      ...
      <div>
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
          <h2 className="text-xl md:text-2xl font-semibold">Recent Analyses</h2>
          <Link to="/history" className="text-xs md:text-sm text-primary hover:underline w-fit">
            View All History →
          </Link>
        </div>
        {recentAnalyses.length > 0 ? (
          ...
          <div className="p-6 md:p-8 border rounded-lg text-center text-muted-foreground">
            ...
            <p className="text-xs md:text-sm">No analyses yet. Run a quick analysis to see your first results!</p>
          </div>
        )}
      </div>
    </div>
    ...
    <div className="space-y-8 md:space-y-12 pb-20 md:pb-8">
      ...
      <div className="text-center space-y-4 md:space-y-6 py-6 md:py-8">
        <div className="space-y-3 md:space-y-4">
          ...
          <p className="text-xs md:text-base lg:text-lg text-muted-foreground max-w-3xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3 md:gap-4 justify-center px-4">
          <Link
            to="/chat"
            className="inline-flex items-center justify-center gap-2 px-4 md:px-6 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 transition-colors mobile-tap min-h-[44px] text-sm md:text-base"
          >
            Start Chatting
            <ArrowRight size={18} />
          </Link>
          <Link
            to="/analysis"
            className="inline-flex items-center justify-center gap-2 px-4 md:px-6 py-3 border border-border rounded-lg font-medium hover:bg-accent transition-colors mobile-tap min-h-[44px] text-sm md:text-base"
          >
            Quick Analysis
          </Link>
        </div>
      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
          {/* Feature 1 */}
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              <div className="p-2 rounded-lg bg-primary/10 flex-shrink-0">
                <Target className="text-primary" size={20} />
              </div>
              <h3 className="text-base md:text-lg font-semibold">Intelligent Timing</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Multi-Source Intelligence</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Dual ML Predictions</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Risk-Aware Engine</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Explainable AI</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="p-4 md:p-6 border rounded-lg bg-card hover:shadow-lg transition-shadow">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Flexible Access</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground">
      ...
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
          {/* Layer 1 */}
          <div className="relative p-4 md:p-6 border rounded-lg bg-card">
            <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-sm">
              1
            </div>
            <div className="flex items-center gap-3 mb-3">
              <Database className="text-primary flex-shrink-0" size={20} />
              <h3 className="text-base md:text-lg font-semibold">Data Collection</h3>
            </div>
          ...
          <div className="relative p-4 md:p-6 border rounded-lg bg-card">
            ...
            <div className="flex items-center gap-3 mb-3">
              <Brain className="text-primary flex-shrink-0" size={20} />
              <h3 className="text-base md:text-lg font-semibold">ML Prediction</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground mb-2">
          ...
          <div className="relative p-4 md:p-6 border rounded-lg bg-card">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Decision Engine</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground mb-2">
          ...
          <div className="relative p-4 md:p-6 border rounded-lg bg-card">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-base md:text-lg font-semibold">Supervisor</h3>
            </div>
            <p className="text-xs md:text-sm text-muted-foreground mb-2">
      ...
      {/* Getting Started */}
      <div className="space-y-4 md:space-y-6 bg-accent/30 rounded-lg p-4 md:p-8">
        <div className="text-center px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-5xl mx-auto">
          ...
          <div className="text-center space-y-2 md:space-y-3">
            <div className="w-12 h-12 md:w-16 md:h-16 rounded-full bg-primary text-primary-foreground flex items-center justify-center font-bold text-xl md:text-2xl mx-auto">
              1
            </div>
          ...
          <div className="text-center space-y-2 md:space-y-3">
            ...
            <h3 className="text-base md:text-xl font-semibold">Get Your Recommendation</h3>
            <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="text-center space-y-2 md:space-y-3">
            ...
            <h3 className="text-base md:text-xl font-semibold">Explore the Evidence</h3>
            <p className="text-xs md:text-sm text-muted-foreground">
      ...
      <div className="space-y-4 md:space-y-6">
        <div className="px-4">
          <h2 className="text-2xl md:text-3xl font-bold">Your Dashboard</h2>
