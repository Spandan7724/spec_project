        ...
        <div className="min-w-[700px] h-full">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              />
              <YAxis
                label={{ value: 'Price', angle: -90, position: 'insideLeft', offset: 10, style: { fontSize: 12 } }}
                domain={['auto', 'auto']}
                width={80}
                tick={{ fontSize: 12 }}
              />
          ...
          <div className="min-w-[700px] h-full">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={chartData}>
                ...
                />
                <YAxis label={{ value: 'Volume', angle: -90, position: 'insideLeft', style: { fontSize: 12 } }} tick={{ fontSize: 12 }} />
                <Tooltip
